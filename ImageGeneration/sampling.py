...
def get_rectified_flow_sampler(sde, shape, inverse_scaler, device='cuda'):
  ...
  def euler_sampler(model, z=None):
    ...
    with torch.no_grad():
      ...
      if z is None:
        ...
        z0 = torch.load('/home/lrl/rectifiedflow/RectifiedFlow/ImageGeneration/logs/celebahq/eval/ckpt_10/z_0.pt')
        x = z0.detach().clone()
      else:
        x = z
      ...
      for i in range(N):
        ...
        if (N - i <= 10 or i <= 10) :
          torch.save(x, f'/home/lrl/rectifiedflow/RectifiedFlow/ImageGeneration/logs/celebahq/eval/ckpt_10/z_{i + 1}_euler.pt')
  ...
  def euler_reversal(model, z1=None):
    ...
    with torch.no_grad():
      ...
      for i in range(N, 0, -1):
        ...
        z = z - pred * dt
        if (N - i <= 10 or i <= 10):
          torch.save(z, f'/home/lrl/rectifiedflow/RectifiedFlow/ImageGeneration/logs/celebahq/eval/ckpt_10/z_{i-1}_rev_euler.pt')
  ...
  def euler_reconstruction(model, z0_rev=None):
    ...
    with torch.no_grad():
      ...
      for i in range(N):
        ...
        x = x.detach().clone() + pred * dt
        if (N - i <= 10 or i <= 10) :
          torch.save(x, f'/home/lrl/rectifiedflow/RectifiedFlow/ImageGeneration/logs/celebahq/eval/ckpt_10/z_{i + 1}_rec_euler.pt')
  ...
  def leapfrog_sampler(model, z=None):
    ...
    with torch.no_grad():
      ...
      torch.save(z, '/home/lrl/rectifiedflow/RectifiedFlow/ImageGeneration/logs/celebahq/eval/ckpt_10/z_1_leapfrog.pt')
      ...
      for i in range(1, 2 * sde.sample_N):
        ...
        if (2 * sde.sample_N - i <= 10 or i <= 10) :
          torch.save(z_next, f'/home/lrl/rectifiedflow/RectifiedFlow/ImageGeneration/logs/celebahq/eval/ckpt_10/z_{i+1}_leapfrog.pt')
        z_prev, z = z, z_next
      
      x = inverse_scaler(z)
      # torch.save(z, '/home/lrl/rectifiedflow/RectifiedFlow/ImageGeneration/logs/celebahq/eval/ckpt_10/z_1.pt')
      # torch.save(z_prev, '/home/lrl/rectifiedflow/RectifiedFlow/ImageGeneration/logs/celebahq/eval/ckpt_10/z_{1-1_2N}.pt')
  ...
  def leapfrog_reversal(model, z1=None, z_1_1_2N=None):
    ...
    with torch.no_grad():
      ...
      pred = model_fn(z_prev, t * 999)
      z = z_prev.detach().clone() - pred * dt / 2   # single step Euler
      # z = z_1_1_2N.detach().clone()
      torch.save(z, f'/home/lrl/rectifiedflow/RectifiedFlow/ImageGeneration/logs/celebahq/eval/ckpt_10/z_{2 * sde.sample_N - 1}_rev_leapfrog.pt')
  ...
  def leapfrog_reconstruction(model, z0=None, z_1_2N=None):
    ...
    with torch.no_grad():
      ...
      torch.save(z, '/home/lrl/rectifiedflow/RectifiedFlow/ImageGeneration/logs/celebahq/eval/ckpt_10/z_1_rec_leapfrog.pt')
      ...
      for i in range(1, 2 * sde.sample_N):
        ...
        z_next = z_prev + pred * dt
        if (2 * sde.sample_N - i <= 10 or i <= 10) :
          torch.save(z_next, f'/home/lrl/rectifiedflow/RectifiedFlow/ImageGeneration/logs/celebahq/eval/ckpt_10/z_{i+1}_rec_leapfrog.pt')
        z_prev, z = z, z_next
  ...
  def rk45_reconstruction(model_fn, z0_inv=None):
    with torch.no_grad():
      ...
      print("Time Steps:", solution.t)
      torch.save(x, f'/home/lrl/rectifiedflow/RectifiedFlow/ImageGeneration/logs/celebahq/eval/ckpt_10/z_rec_rk45.pt')
